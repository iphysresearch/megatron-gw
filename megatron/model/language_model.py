...
def parallel_lm_logits(input_, word_embeddings_weight, parallel_output,
    ...
    #print("word_embedding_weight shape: {}".format(word_embeddings_weight.shape))
    # Matrix multiply.
    word_embeddings_weight = word_embeddings_weight.transpose(0, 1) 
    #print("word_embedding_weight shape after transpose: {}".format(word_embeddings_weight.shape))
    ...
    # Gather if needed.
    #print("logits_parallel shape: {}".format(logits_parallel.shape))
    if parallel_output:
        return logits_parallel

    #print("output shape: {}".format(mpu.reduce_from_tensor_model_parallel_region(logits_parallel).shape))
